...
const CopyPasteInput: React.FC<StringInputProps> = ({id}) => {
  ...
  const duplicateDisable =
    Object.values(checkedPages).filter((value) => value).length < 1 || isLoadingPaste
  useEffect(() => {
      ...
      <Stack space={1}>
                ...
                <Box className="relative overflow-visible h-[31.25rem]">
                  ...
                  >
                    <Button
                      ...
                      className={cn(duplicateDisable ? 'cursor-not-allowed' : 'cursor-pointer')}
                    />
                    <Button
                      text={
                        isLoadingPaste
        ...
        <Flex gap={2} align="center">
          ...
          <Button
            ...
            className={cn(
              allowedToPaste && !isLoadingPaste ? 'cursor-pointer' : 'cursor-not-allowed',
            )}
          />
        </Flex>
      </Stack>
